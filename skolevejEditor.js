...
(function() {
  window.skolevejEditor = function(mapId, apiUrl) {
    var Button, SchoolChoice, createPopUp, currentSchool, defaultIntersectionType, defaultRouteType, doExport, initMap, items, latLng2array, loadAndShowSchool, map, renderCurrentSchool, routeColors, saveAndUpload, saveIndicator, statusPopUpIntersection, statusPopUpRoute, statusShowing, upload;
